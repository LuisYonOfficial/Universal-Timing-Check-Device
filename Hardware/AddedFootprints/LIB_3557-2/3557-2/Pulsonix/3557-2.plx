...
(library Library_1
	...
	(patternDef "3557-2" (originalName "3557-2")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.597, -0.218) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -9.905 3.365) (pt 9.905 3.365) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 9.905 3.365) (pt 9.905 -3.365) (width 0.025))
		)
	...
	(compDef "3557-2" (originalName "3557-2") (compHeader (numPins 4) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "http://www.keyelco.com/product-pdf.cfm?p=296")
		(attr "<STEP Filename>" "3557-2.stp")
		(attr "<STEP Offsets>" "X=-9.01;Y=15.51;Z=-6.32")
