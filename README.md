...
Image below shows a general esimate of how I intended the board to look like and inspired by (although to be at a much much smaller dimensional board footprint with no microcontroller / FPGA variant)
...
## What to do next
- Finish basic logic check circuitry for 5 signals.
